...
import clarieProfile from "@/assets/clarie-profile.jpg";
...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full opacity-15 blur-3xl bg-primary pointer-events-none" />
      ...
      <div className="section-container flex flex-col items-center text-center z-10">
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-xl mb-8 opacity-0 animate-fade-up delay-100">
          Information Systems Student | Lifelong Learner
        </p>
